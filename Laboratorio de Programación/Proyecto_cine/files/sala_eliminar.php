...
<?php
    ...
    if($conexion->connect_error){
        ...
        if(!$id){ 
            echo '<div class="container">';
            echo '<div class="alert alert-danger" style="padding: 10px;">';
            echo '<strong>ERROR: no se encontró el ID de la sala.</strong>';
            echo '</div>';
            echo '</div>';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Eliminar la sala de la base de datos?</p>
                        </div>
                        <div class="modal-footer">
                            <form method="post" action="files/sala_eliminar.php" class="form-horizontal">
            ...
            <div class="container-fluid col-xs-10 col-sm-6 col-md-4 col-lg-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">Sala seleccionada</h2>
                    </div>
                    <div class="panel-body table-responsive text-center">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
<?php
                                echo '<td>'.$sala->getId().'</td>';
                                echo '<td>'.$sala->getCapacidad().'</td>';
                                echo '<td>'.$sala->getDisponibilidad().'</td>';
?>
                            </tbody>
                        </table>    
                    </div>
        ...
        <div class="row">
            ...
            <div class="container-fluid col-xs-10 col-sm-6 col-md-4 col-lg-2">
                <form method="post" action="files/sala_eliminar.php" class="form">
        ...
        <div class="row">
            ...
            <div class="container text-center col-xs-10 col-sm-4 col-md-6 col-lg-6">
                ...
                <div class="alert alert-success" style="padding: 10px;">
                    <strong>La sala ha sido eliminada de la base de datos.</strong>
                </div>
            </div>
            <div class="col-xs-1 col-sm-4 col-md-3 col-lg-3"></div>
        </div>
        <div class="row row-centrada">
            <a id="btn-regresar" href="files/sala_busqueda.php" class="link-mid"><img src="img/botones/regresar-negro.svg" class="link-img"></a>
        </div>
<?php
    }
?>
